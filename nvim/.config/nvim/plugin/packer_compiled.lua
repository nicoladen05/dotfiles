...
_G.packer_plugins = {
  Colorschemes = {
    loaded = true,
    path = "/home/nico/.local/share/nvim/site/pack/packer/start/Colorschemes",
  ...
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/nico/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/nico/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/nico/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/nico/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
  ...
  ["nvim-transparent"] = {
    loaded = true,
    path = "/home/nico/.local/share/nvim/site/pack/packer/start/nvim-transparent",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/nico/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
